...
import ExportConversations from '../SettingsTabs/Data/ExportConversations';
...
export const registry: SettingEntry[] = [
  ...
  },
  {
    ...
    tab: DATA,
    section: 'data',
    labelKey: 'com_ui_settings_label_export',
    keywords: ['export', 'download', 'backup', 'json', 'conversations'],
